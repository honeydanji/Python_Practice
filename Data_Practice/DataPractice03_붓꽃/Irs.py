...
## version 1(Train과 Test로 나누지 않고, KNN 분류기) + 모델 성능 검사 및 향상
...
logreg = LogisticRegression() ### 로지스틱 회귀 알고리즘 객체 생성
logreg.fit(X,y) ### 학습시키기
y_pred = logreg.predict(X) ### 예측값 변수 초기화
print(metrics.accuracy_score(y, y_pred))

## version 2(Train과 Test로 나누고, KNN분류기)
